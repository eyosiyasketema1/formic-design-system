...
> = {
  Steps: {
    ...
    rows: [
      { primary: "Reading the brief" },
      { primary: "Checking the client's site" },
      { primary: "Comparing three layouts", secondary: "3 options" },
      { primary: "Writing the summary" },
    ],
  },
  Reasoning: {
    active: "Thinking",
    ...
    rows: [
      { primary: "Most visitors leave at the pricing section, so the redesign should start there." },
      { primary: "I should check the analytics before proposing a new navigation." },
    ],
  },
  Search: {
    active: "Searching the web",
    done: "Searched the web",
    query: "design system for the redesign",
    rows: [
      { primary: "Formic AI Design System", secondary: "formicai.dev", href: "https://formicai.dev/" },
      { primary: "Gallery", secondary: "formicai.dev/preview.html", href: "https://formicai.dev/preview.html" },
      { primary: "Customize", secondary: "formicai.dev/customize", href: "https://formicai.dev/customize" },
    ],
    more: "+7 more",
  },
  Coding: {
    ...
    rows: [
      { primary: "Read", secondary: "brief.md", mono: true },
      { primary: "Edit", secondary: "Pricing.tsx", mono: true, add: 74, del: 41 },
