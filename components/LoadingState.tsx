  ...
  if (surfer) {
    return (
      <div role="status" className="flex w-fit flex-col items-start">
        ...
        <div
          className="mt-2 w-56 overflow-hidden rounded-md shadow-overlay"
          style={{ animation: "pop-in 200ms var(--ease-out-quint) both", transformOrigin: "top left" }}
        >
          <div className="relative aspect-video w-full" style={{ background: "var(--tooltip-bg)" }}>
            {videoOk ? (
              ...
              <div className="flex h-full w-full flex-col items-center justify-center gap-1.5">
                <LoaderGrid {...PATTERNS.Drive} />
                <span className="px-3 text-center font-mono text-micro" style={{ color: "var(--tooltip-muted)" }}>
                  Video unavailable
                </span>
              </div>
            )}
